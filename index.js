...
document.addEventListener("DOMContentLoaded", function () {
  emailjs.init("VDuqIv4SCqEjC9-Ms"); // Your actual EmailJS Public Key
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      if (!name || !email || !subject || !phone || !message) {
        alert("Please fill in all required fields: Name, Email, Phone, Subject, and Message.");
        return; // stop form submission
      }

      emailjs.sendForm("service_4224bxh", "template_nvj6fc8", form) // ✅ fixed 'services' → 'service'
        .then(() => {
